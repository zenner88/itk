...
export class SmartTableComponent {
  ...
  ngOnInit(): void {
    ...
    this.httpClient.get(this._global.baseAPIUrl + '/View_penilaians/',httpOptions).subscribe(indikator => {
  ...
  onCreateConfirm(event): void {
    ...
    // // }
    // else{
    this.httpClient.post(this._global.baseAPIUrl + '/Itk_trn_penilaians/',event.newData,httpOptions).subscribe(data  => {
  ...
  onSaveConfirm(event): void {
    ...
    // }
    // else{
    this.httpClient.put(this._global.baseAPIUrl + '/Itk_trn_penilaians/'+event.data.kode,event.newData,httpOptions).subscribe(data  => {
  ...
  onDeleteConfirm(event): void {
    if (window.confirm('Are you sure you want to delete?')) {
      this.httpClient.delete(this._global.baseAPIUrl + '/Itk_trn_penilaians/'+event.data.kode,httpOptions).subscribe(data => {
        event.confirm.resolve();
  ...
  onCreateConfirmD(event): void {
    ...
    this.httpClient.post(this._global.baseAPIUrl + '/Itk_trn_penilaian_details',this.detailsData,httpOptions).subscribe(data  => {
      console.log("POST Request is successful ", data);
      this.showToast("success", "Data Tersimpan", event.newData.jenis);
      event.confirm.resolve();
    },
  ...
  onSaveConfirmD(event): void {
    ...
    console.log(this.detailsData);
    this.httpClient.put(this._global.baseAPIUrl + '/Itk_trn_penilaian_details/'+event.data.kode,this.detailsData,httpOptions).subscribe(data  => {
      console.log("PUT Request is successful ", data);
      this.showToast("success", "Data Ter update", event.newData.kode);
      event.confirm.resolve();
    },
  ...
  onDeleteConfirmD(event): void {
    if (window.confirm('Are you sure you want to delete?')) {
      this.httpClient.delete(this._global.baseAPIUrl + '/Itk_trn_penilaian_details/'+event.data.kode,httpOptions).subscribe(data => {
        event.confirm.resolve();
        console.log(event.data.kode);
        this.showToast("danger", "Data terhapus", event.data.jenis+"("+event.data.id+")");
      });
