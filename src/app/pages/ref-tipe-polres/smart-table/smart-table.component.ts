...
export class SmartTableComponent {
  ...
  onCreateConfirm(event): void {
    ...
    this.httpClient.post(this._global.baseAPIUrl + '/Itk_ref_tipe_polres',event.newData).subscribe(data  => {
  ...
  onSaveConfirm(event): void {
    ...
    this.httpClient.put(this._global.baseAPIUrl + '/Itk_ref_tipe_polres/'+event.data.id,event.newData).subscribe(data  => {
  ...
  onDeleteConfirm(event): void {
    if (window.confirm('Are you sure you want to delete?')) {
      this.httpClient.delete(this._global.baseAPIUrl + '/Itk_ref_tipe_polres/'+event.data.id).subscribe(data => {
        event.confirm.resolve();
