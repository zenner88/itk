...
@Component({
  selector: "ngx-top-ten-indikator-chart",
  styleUrls: ["./top-ten-indikator-chart.component.scss"],
  template: `
...
export class TopTenIndikatorChartComponent
  ...
  ngAfterViewInit() {
    ...
    this.httpClient
      .get(
        this._global.baseAPIUrl + "/View_penilaians",httpOptions
      )
      .subscribe(
        datas => {
