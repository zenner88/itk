...
@Component({
  selector: "ngx-bottom-ten-chart",
  styleUrls: ["./bottom-ten-chart.component.scss"],
  template: `
    <div class="row" *ngIf="loaded">
      <div class="col-md-12 col-sm-12" style="text-align:center">
        <canvas
          ...
          width="80vw"
          baseChart
          [data]="chartRangkingITK[0].barChartData"
          [labels]="chartRangkingITK[0].barChartLabels"
...
export class BottomTenChartComponent
  ...
  ngAfterViewInit() {
    ...
    this.httpClient
      .get(
        this._global.baseAPIUrl + "/View_penilaian_satfungs/getNilaiPerSatker",httpOptions
      )
      .subscribe(
        datas => {
