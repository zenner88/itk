...
@Component({
  selector: "ngx-indeks-umum-polda-chart",
...
export class IndeksUmumPoldaChartComponent
  ...
  ngAfterViewInit() {
    var satkerInduk = localStorage.getItem("namaUser");
    if (!satkerInduk) {
      satkerInduk = "";
    }
    ...
    this.httpClient
      .get(
        this._global.baseAPIUrl +
          "/View_penilaians/getDataItkPokjaPolda?satkerInduk=" +
          satkerInduk,
        httpOptions
      )
      .subscribe(
