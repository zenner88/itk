...
export class SmartTableComponent {
  ...
  satfungx: any;
  polresx: any;
  kodeSatker: any= 651554;
  ngOnInit(): void {
    this.satfungs = this.loadTableSettings(); 
    this.httpClient.get(this._global.baseAPIUrl + '/View_penilaian_satfungs/getDataBykodeSatker?kodeSatker='+this.kodeSatker).subscribe(indikator => {
