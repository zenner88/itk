...
@Component({
  selector: "ngx-bottom-ten",
  styleUrls: ["./bottom-ten.component.scss"],
  template: `
    <nb-card>
      <nb-card-header>BOTTOM TEN POLRES</nb-card-header>
      <nb-card-body>
        <ngx-bottom-ten-chart
...
export class BottomTenComponent implements OnDestroy {
  private alive = true;
